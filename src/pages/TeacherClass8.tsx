...
const classStudents = [
  { id: 1, name: 'Ananya Joshi', attendance: 94, performance: 88, lastActive: '1 hour ago', status: 'active' },
  { id: 2, name: 'Badal Kumar', attendance: 86, performance: 81, lastActive: '3 hours ago', status: 'active' },
  { id: 3, name: 'Chandni Shah', attendance: 92, performance: 94, lastActive: '2 hours ago', status: 'active' },
  { id: 4, name: 'Darshan Patel', attendance: 78, performance: 72, lastActive: '2 days ago', status: 'inactive' },
  { id: 5, name: 'Ekta Sharma', attendance: 89, performance: 85, lastActive: '5 hours ago', status: 'active' },
  { id: 6, name: 'Faizan Ahmed', attendance: 82, performance: 79, lastActive: '1 day ago', status: 'inactive' },
  { id: 7, name: 'Gauri Mishra', attendance: 95, performance: 90, lastActive: '4 hours ago', status: 'active' },
  { id: 8, name: 'Himanshu Singh', attendance: 91, performance: 87, lastActive: '6 hours ago', status: 'active' },
  { id: 9, name: 'Ishan Mehta', attendance: 84, performance: 76, lastActive: '3 days ago', status: 'inactive' },
];
  ...
  return (
    <TeacherPageContainer>
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold mb-1">Class 8</h1>
          <p className="text-gray-500">Manage your Class 8 students and content</p>
        </div>
        <div className="flex gap-3">
          <Button 
            ...
            asChild
          >
            <Link to="/teacher/reports?class=8">
        ...
        <TabsContent value="students">
          <Card>
            <CardHeader className="pb-2">
              <CardTitle>Class 8 Students</CardTitle>
              <CardDescription>Manage all students in Class 8</CardDescription>
        ...
        <TabsContent value="content">
          ...
          {activeContent.length === 0 && (
            <div className="text-center py-10">
              ...
              <p className="text-gray-500 mb-4">There's no active content for Class 8 right now.</p>
              <Button 
                asChild
                className="bg-indigo-600 hover:bg-indigo-700"
              >
        ...
        <TabsContent value="upcoming">
          ...
          {upcomingContent.length === 0 && (
            <div className="text-center py-10">
              ...
              <p className="text-gray-500 mb-4">There's no upcoming content for Class 8 right now.</p>
              <Button 
                asChild
                className="bg-indigo-600 hover:bg-indigo-700"
              >
